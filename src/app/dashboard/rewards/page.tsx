...
import {
  Ticket, Gift, Clock, CheckCircle, XCircle, Percent, Sparkles, Gem, Star, Copy, Check,
...
const REWARDS_STATS = [
  { label: 'Active Coupons', value: '2', icon: Ticket, color: 'text-brand-gold', bg: 'bg-brand-gold/5' },
  { label: 'Expired Coupons', value: '1', icon: XCircle, color: 'text-red-500', bg: 'bg-red-500/5' },
  { label: 'Total Saved', value: '₦12,500', icon: Sparkles, color: 'text-green-600', bg: 'bg-green-500/5' },
  { label: 'Reward Points', value: '850', icon: Star, color: 'text-amber-600', bg: 'bg-amber-500/5' },
];
...
const COUPONS = [
  {
    code: 'WELCOME25',
    discount: '25% Off',
    description: 'Discount on any custom portrait commission',
    type: 'Percentage',
    icon: Percent,
    expires: 'Jun 30, 2026',
    used: 1,
  ...
  {
    code: 'FREEFRAME',
    discount: 'Free Frame Upgrade',
    description: 'Complimentary museum-grade frame upgrade',
    type: 'Free Upgrade',
    icon: Gem,
    expires: 'Jul 15, 2026',
    used: 0,
                ...
                <div className="flex items-start justify-between mb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-brand-gold/10 flex items-center justify-center">
                      <coupon.icon size={18} className="text-brand-gold" />
                    </div>
                    <div>
  ...
  return (
    <div className="p-6 md:p-10">
      <motion.div {...fadeUp(0)}>
        ...
        >
          {activeTab === 'coupons' ? <CouponsTab /> : <VideoRewardsTab />}
        </motion.div>
      </motion.div>
    </div>
  );
