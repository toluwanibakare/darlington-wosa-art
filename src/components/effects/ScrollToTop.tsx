    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          className="fixed bottom-6 right-5 sm:right-8 z-50 w-12 h-12 rounded-full bg-brand-surface/80 backdrop-blur-xl border border-brand-border/60 hover:border-brand-gold/60 shadow-lg hover:shadow-[0_0_30px_rgba(158,101,27,0.25)] flex items-center justify-center cursor-pointer group transition-all duration-500"
        ...
        >
          ...
          <motion.svg
            ...
            className="relative text-brand-black dark:text-white group-hover:text-brand-gold transition-colors duration-500"
