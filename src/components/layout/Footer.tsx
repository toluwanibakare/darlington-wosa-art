      ...
      <div className="max-w-[1800px] mx-auto px-6 md:px-16 pt-32 pb-12">
        ...
        <div className="mt-32 pt-8 border-t border-brand-border flex flex-col md:flex-row items-center justify-between gap-6 font-sans text-xs tracking-wider uppercase">
          ...
          <div className="flex items-center gap-6">
            <a href="https://www.instagram.com/darlingtonwosa_art/" target="_blank" rel="noopener noreferrer" className="text-brand-gray/60 hover:text-brand-black transition-colors duration-300" aria-label="Instagram">
            ...
            <a href="https://vm.tiktok.com/ZS9MKs8rJcjTj-X4Iea/" target="_blank" rel="noopener noreferrer" className="text-brand-gray/60 hover:text-brand-black transition-colors duration-300" aria-label="TikTok">
